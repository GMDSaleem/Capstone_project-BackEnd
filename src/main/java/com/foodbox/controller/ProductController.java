...
public class ProductController {
	...
	public List<Product> getAllProducts() {
		...
		if(prodList.isEmpty()) {
			...
			addProdIfEmpty(new Product(1,"chilli Chicken","Chicken infused with chilli and spices","Indian",250,0,0,"yes","./assets/images/ButterChicken.png"));
			...
			addProdIfEmpty(new Product(4,"chicken Fried Rice","Rice with chicken and Chinese sauses","Chinese",95,5,0,"yes","./assets/images/EggfriedRice.jpg"));
			addProdIfEmpty(new Product(2,"mushroom Pizza","Pizza topped with cotted cheese and vegies","Italian",435,0,0,"yes","./assets/images/paneerpizza.jpg"));
